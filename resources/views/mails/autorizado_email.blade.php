...
<body>
	@foreach ($msg as $valores)
		<p>Buen día, Correo del Gerente de compras para proceder con la compra de la cotización</p>
		<p>Se ha generado una solicitud para el gasto de viaje # {{$valores->id_requests}}</p>
		<p>A continuación se detallan los datos de la solicitud la cual usted debera validar y confirmar la aprobación con el fin de realizar la compra</p>
		<p>Para proceder con la autorización debe ingresar a la aplataforma de viajes</p>
