...
<body>
	@foreach ($msg as $valores)
		<p>Buen día, Correo para que el jefe apruebe el gasto de viaje</p>
		<p>Se ha generado una solicitud para el gasto de viaje # {{$valores->id_requests}}</p>
		<p>A continuación se detallan los datos de la solicitud la cual usted debera validar y confirmar la aprobación</p>
		...
		<a href="http://localhost/laravel/viajes-app/public/mails/{{$valores->id_quotations}}/autoriza_email"><button id="btn_aceptar">Aceptar</button></a>
